...
def breast_arg():
    ...
    parser.add_argument('--model', type=str, default='vgg', help='{vgg, alexnet, effnet, senet}')
    ...
    parser.add_argument('--cat_feat', type=bool, default=False, help='cat features or not')
